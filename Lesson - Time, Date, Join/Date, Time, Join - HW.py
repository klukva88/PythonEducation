...
print(f' Время через 2 месяца от текущей даты - {afterTwoMonth.strftime("%d %B %y %I:%M")}')
print(f' Время через 2 года от текущей даты - {afterTwoYears.strftime("%d %B %y %I:%M")}')
print(f' Время через 1 год и 2 дня от текущей даты - {afterOneYearTwoDays.strftime("%d %B %y %I:%M")}')
print(f' Время через 3 месяца и 3 дня от текущей даты - {afterTreeMonthThreeDays.strftime("%d %B %y %I:%M")}')
